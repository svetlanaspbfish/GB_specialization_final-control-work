...
<a href="final-control-work_prog/">Програма написана.</a> Реализовано всё, что предполагалось заданием. Реализовано не всё из того, что предполагалось бы логикой классов и программы.
...
<a href="final-control-work_prog/final-control-work_prog/src/model/Counter.java">Файл с классом.</a> 
<a href="f/final-control-work_prog/src/view/consoleUI/menuComands/AddNewAnimal.java">Файл с вызовом.</a> 
